...
/* ━━━ えらぶメシ データ ━━━ */
const foodItems = [
  { src: "/images/1-okinoerabu/oke-21.jpg", caption: "マンゴージュースが出てくる\n居酒屋は多く\nノンアル界隈にはうれしい" },
  { src: "/images/1-okinoerabu/oke-24.jpg", caption: "沖縄の文化も入ってるから\n沖縄そばも\nちゃんとうまい" },
  { src: "/images/1-okinoerabu/oke-27.jpg", caption: "おきえらぶフローラルホテルの\n朝食ブッフェでは\n鶏飯（けいはん）が味わえる" },
  { src: "/images/1-okinoerabu/oke-44.jpg", caption: "野生のみかんは\n種がでかくて\n酸っぱかった" },
  { src: "/images/1-okinoerabu/oke-68.jpg", caption: "チキンがうまい\n豚肉もうまい\n牛もうまい" },
  { src: "/images/1-okinoerabu/oke-69.jpg", caption: "試食でこの量\n新しい冷凍技術を\n魚のうまさで試すのだとか" },
  { src: "/images/1-okinoerabu/oke-158.jpg", caption: "見たことないものが\n食べられるのがうれしい\nこれはいかのかまぼこ" },
  { src: "/images/1-okinoerabu/oke-156.jpg", caption: "いもを餅にしたもの\n信じられないくらい\nうまかった" },
  { src: "/images/1-okinoerabu/oke-166.jpg", caption: "シェフが気分でつくる\nごっついコロッケ\nじゃがの香りがすごい" },
  { src: "/images/1-okinoerabu/oke-265.jpg", caption: "ナンコツ丼は\nコラーゲンたっぷりの\n豚丼だった（量がすごい）" },
];

/* ━━━ スポット写真 ━━━ */
const spotPhotos = [
  { src: "/images/1-okinoerabu/oke-236.jpg", name: "フーチャ", w: 165, h: 262, color: "#b325f6" },
  { src: "/images/1-okinoerabu/oke-257.jpg", name: "越山展望所", w: 175, h: 262, color: "#1701f5" },
  { src: "/images/1-okinoerabu/oke-127.jpg", name: "ひみつのビーチ", w: 175, h: 262, color: "#90d9ee" },
  { src: "/images/1-okinoerabu/oke-58.jpg", name: "田皆岬", w: 345, h: 262, color: "#75fb55" },
  { src: "/images/1-okinoerabu/oke-47.jpg", name: "アーニマガヤ\nトゥール墓", w: 173, h: 262, color: "#f2a53a" },
];
    ...
    return (
      <div className="w-full max-w-[393px] mx-auto flex flex-col items-center justify-center relative overflow-hidden" style={{ fontFamily: "'Noto Sans JP', sans-serif", minHeight: "100dvh" }}>
        <div className="absolute inset-0">
          <Image src="/images/1-okinoerabu/oke-236.jpg" alt="" fill className="object-cover" priority />
  ...
  return (
    <div className="w-full max-w-[393px] mx-auto bg-white" style={{ fontFamily: "'Noto Sans JP', sans-serif", overflowX: "hidden" }}>
      ...
      <section className="relative w-full overflow-hidden" style={{ height: 852 }}>
        <div className="absolute inset-0">
          <Image src="/images/1-okinoerabu/oke-236.jpg" alt="沖永良部島の海" fill className="object-cover" style={{ objectPosition: "center" }} priority />
        </div>
      ...
      <section className="relative w-full bg-white">
        <Image src="/images/1-okinoerabu/section2.png" alt="4年ぶり3回目のえらぶ" width={642} height={1182} className="w-full h-auto" />
      </section>
      ...
      <section className="relative w-full">
        <Image src="/images/1-okinoerabu/スクリーンショット 2026-03-25 22.42.54.png" alt="沖永良部島 基本情報" width={393} height={852} className="w-full h-auto" />
      ...
      <section className="relative" style={{ height: 1797 }}>
        ...
        <div className="absolute w-full" style={{ top: 0, height: 524 }}>
          <Image src="/images/1-okinoerabu/P3233420.JPG" alt="ケイビング" fill className="object-cover" />
        </div>
        {/* Caving title */}
        ...
        <div className="absolute w-full" style={{ top: 524, height: 524 }}>
          <Image src="/images/1-okinoerabu/IMG_1679.JPG" alt="鍾乳洞" fill className="object-cover" />
        </div>
        ...
        <div className="absolute w-full" style={{ top: 1048, height: 454 }}>
          <Image src="/images/1-okinoerabu/P3233431.JPG" alt="鍾乳洞の奥" fill className="object-cover" />
        </div>
        {/* ウ character */}
        ...
        <div className="absolute w-full" style={{ top: 1502, height: 295 }}>
          <Image src="/images/1-okinoerabu/P3233471.JPG" alt="地上へ" fill className="object-cover" />
        </div>
      </section>
      ...
      <section className="relative overflow-hidden" style={{ height: 656 }}>
        <div className="absolute" style={{ left: -22, top: 0, width: 437, height: 656 }}>
          <Image src="/images/1-okinoerabu/oke-71.jpg" alt="沖永良部の風景" fill className="object-cover" />
        </div>
        ...
        <div className="absolute flex" style={{ left: 39, right: 39, top: 239 }}>
          <div className="relative" style={{ width: "33.33%", height: 158 }}><Image src="/images/1-okinoerabu/oke-78.jpg" alt="西郷1" fill className="object-cover" /></div>
          <div className="relative" style={{ width: "33.33%", height: 158 }}><Image src="/images/1-okinoerabu/oke-80.jpg" alt="西郷2" fill className="object-cover" /></div>
          <div className="relative" style={{ width: "33.34%", height: 158 }}><Image src="/images/1-okinoerabu/oke-87.jpg" alt="西郷3" fill className="object-cover" /></div>
        </div>
      ...
      <section className="bg-white">
        ...
        <div className="relative w-full" style={{ height: 261 }}>
          <Image src="/images/1-okinoerabu/map.png" alt="沖永良部島マップ" fill className="object-cover" />
        </div>
        ...
        <div className="gallery-scroll flex" style={{ gap: 0 }}>
          <div className="flex-shrink-0 relative" style={{ width: 345, height: 262 }}>
            <Image src="/images/1-okinoerabu/oke-220.jpg" alt="ガジュマル" fill className="object-cover" />
      ...
      <section className="bg-white" style={{ padding: "32px 36px 32px" }}>
        ...
        <div style={{ marginTop: 32, marginBottom: 32 }}>
          <Image src="/images/1-okinoerabu/oke-162.jpg" alt="フローラルホテル" width={320} height={0} className="w-full h-auto" style={{ display: "block" }} />
        </div>
        <div style={bodyText}>
      ...
      <section className="relative overflow-hidden">
        {/* 背景写真（明るく飛ばす） */}
        <div className="absolute inset-0">
          <Image src="/images/1-okinoerabu/oke-11.jpg" alt="あざシール" fill className="object-cover" style={{ filter: "brightness(1.6) contrast(0.85)" }} />
      ...
      <section className="bg-white">
        ...
        <div className="relative w-full" style={{ height: 514 }}><Image src="/images/1-okinoerabu/スクリーンショット 2026-03-25 22.43.54.png" alt="ほうらしゃ人生" fill className="object-cover" /></div>
        ...
        <div className="relative w-full" style={{ height: 589 }}><Image src="/images/1-okinoerabu/oke-261.jpg" alt="施設" fill className="object-cover" /></div>
        <div style={{ ...bodyText, padding: "32px 36px" }}>
          <p>街を歩いていると、「山田明記念美術博物館」を発見する。この島の発展に寄与してきた人物ともなれば、美術博物館のひとつもできるのであろう。残念ながら中には入らなかったが、セスナの模型などが見えた。</p>
        </div>
        <div className="relative w-full" style={{ height: 335 }}><Image src="/images/1-okinoerabu/oke-145.jpg" alt="施設" fill className="object-cover" /></div>
        <div style={{ ...bodyText, padding: "32px 36px" }}>
        ...
        <div className="relative w-full" style={{ height: 485 }}><Image src="/images/1-okinoerabu/oke-136.jpg" alt="記念碑" fill className="object-cover" /></div>
        <div style={{ ...bodyText, padding: "32px 36px" }}>
          <p>そして、ついに、山田グループはこの島の神になった。慈悲の心が、観音を建設させたのである。これを建てることを決めた会議に出席したい。だれが発案し、どのような稟議が決済され、ハンコが押されるのであろうか。</p>
        </div>
        <div className="relative w-full" style={{ height: 599 }}><Image src="/images/1-okinoerabu/oke-138.jpg" alt="観音像" fill className="object-cover" /></div>
        <div style={{ ...bodyText, padding: "32px 36px" }}>
